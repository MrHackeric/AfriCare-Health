...
function Hero() {
  return (
    <section className="hero px-4 py-8 sm:px-6 lg:px-8 bg-[white]">
      <div className="max-w-[1200px] mx-auto flex flex-col md:flex-row items-center md:items-center text-center md:text-left">
        ...
        <div className="md:w-1/2 mb-8 md:mb-0 flex flex-col justify-center">
          <h1 className="text-3xl md:text-4xl font-bold text-gray-800 dark:text-[#874c78] mb-4">
            Welcome to Africare, where we Transform Maternal Health, One Community at a Time
          </h1>
          <p className="text-m dark:text-[#a06e91] mb-6">
        ...
        <a href="/SignUp">
          <button className="bg-[#874c78] text-[white] w-48 mx-auto md:mx-0 px-6 py-3 rounded-[5px] border-2 hover:bg-[#f2b1d0] hover:border-[#874c78] hover:text-[#874c78] transition duration-300">
            Get Started
          </button>
        </a>
